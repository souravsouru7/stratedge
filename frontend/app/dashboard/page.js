          ...
          <>
            ...
            <div style={{ marginBottom: 16, animation: "fadeUp 0.5s ease 0.30s both" }}>
              ...
              <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
                ...
                />
                <NavCard href="/checklist" label="Pre-Trade Checklist" sub="Check rules before trading" accentColor="#0D9E6E" delay={0.46}
                ...
                />
                <NavCard href="/weekly-reports?market=Forex" label="Weekly AI Feedback" sub="Last 7 days review" accentColor="#B8860B" delay={0.48}
